...
internal sealed class TimestampedFileLoggerProvider : ILoggerProvider
{
	...
	public ILogger CreateLogger(string categoryName) => new TimestampedFileLogger(categoryName, _writer, _lock);
	...
	private sealed class TimestampedFileLogger : ILogger
	{
		...
		public TimestampedFileLogger(string categoryName, StreamWriter writer, object lockObject)
		{
